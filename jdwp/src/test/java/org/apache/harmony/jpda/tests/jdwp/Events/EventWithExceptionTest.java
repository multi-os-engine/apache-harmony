...
/**
 * JDWP unit test checking that we can report different events, requested during an EXCEPTION
 * event, after a catch handler.
 */
public class EventWithExceptionTest extends JDWPEventTestCase {
    ...
    /**
     * Tests we properly BREAKPOINT in the catch handler.
     */
     ...
     * Tests we properly BREAKPOINT in the catch handler.
     */
    public void testBreakpoint_OnException() {
        logWriter.println(getName() + " STARTS");
