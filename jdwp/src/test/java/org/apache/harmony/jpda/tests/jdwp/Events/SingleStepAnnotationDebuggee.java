...
/**
 * Debuggee for JDWP SingleStepAnnotationTest unit test which
 * measures single step time.
 */
public class SingleStepAnnotationDebuggee extends SyncDebuggee {
    ...
    public void run() {
        ...
        logWriter.println("SingleStepAnnotationDebuggee started");

        synchronizer.receiveMessage(JPDADebuggeeSynchronizer.SGNL_CONTINUE);

        doCall();

        logWriter.println("SingleStepAnnotationDebuggee finished");
    }

    /**
     * Starts SingleStepAnnotationDebuggee with help of runDebuggee() method
     * from <A HREF="../../share/Debuggee.html">Debuggee</A> super class.
     *
     */
    public static void main(String [] args) {
        runDebuggee(SingleStepAnnotationDebuggee.class);
    }
