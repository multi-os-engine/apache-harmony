...
import org.apache.harmony.jpda.tests.jdwp.Events.MethodExitWithReturnValue002Debuggee;
...
public class DeoptimizationWithExceptionHandlingTest extends JDWPSyncTestCase {
    ...
    private int requestExceptionEvent() {
        ReplyPacket replyPacket =
                debuggeeWrapper.vmMirror.setException("Ljava/lang/NullPointerException;", true, false);
