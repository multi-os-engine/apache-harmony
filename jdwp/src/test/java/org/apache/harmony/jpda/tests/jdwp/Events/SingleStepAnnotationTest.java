 ...
 */
public class SingleStepAnnotationTest extends JDWPEventTestCase {

    private final long STEP_TIME_THRESHOLD = 10 * 1000;

    private String debuggeeSignature = "Lorg/apache/harmony/jpda/tests/jdwp/Events/SingleStepAnnotationDebuggee;";

    private String DEBUGGEE_CLASS_NAME = "org.apache.harmony.jpda.tests.jdwp.Events.SingleStepAnnotationDebuggee";
    ...
    /**
     * This testcase measures how long a step-over takes on a certain heavy method call.
     */
    public void testStepOverTime() {
        ...
        // receive event with STEP_TIME_THRESHOLD as timeout
