...
public class Resume002Test extends JDWPSyncTestCase {
    ...
    public void testResume_PartialSuspension() {
        ...
        // suspended.
        long requestID = installBreakpoint();
    ...
    private long installBreakpoint() {
        ...
        long requestID = breakpointReply.getNextValueAsInt();
        return requestID;
    }

    private void waitBreakpointHits(long requestID) {
