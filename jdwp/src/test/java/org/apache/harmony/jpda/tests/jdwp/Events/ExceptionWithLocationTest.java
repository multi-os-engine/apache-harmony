...
public class ExceptionWithLocationTest extends EventLocationEventTestCase {
     ...
     * <BR>It runs ExceptionLocationDebuggee that throws caught DebuggeeException.
     * The test verifies that requested EXCEPTION event occurs in the
     * expected method by providing a LocationOnly modifier.
     */
    ...
    protected void checkEvent(ParsedEvent event) {
        assertEquals(JDWPConstants.EventKind.EXCEPTION, event.getEventKind());
