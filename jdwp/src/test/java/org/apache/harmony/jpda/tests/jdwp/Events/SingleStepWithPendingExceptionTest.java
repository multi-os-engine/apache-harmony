...
public class SingleStepWithPendingExceptionTest extends JDWPEventTestCase {
    ...
    public void testSingleStepWithPendingException() {
        ...
        // 2 - Wait for exception and remember catch location.
        ...
        // 4 - Install breakpoint at begin of throwMethod.
        ...
        // 6 - Single-step OUT of the throwMethod that will throw an exception.
        debuggeeWrapper.vmMirror.setStep(new String[0], threadId, JDWPConstants.StepSize.LINE, JDWPConstants.StepDepth.OUT);

        // Breakpoint event suspended all threads: resume them now.
        debuggeeWrapper.resume();

        // 7 - Wait for single-step
        eventPacket = debuggeeWrapper.vmMirror.receiveCertainEvent(JDWPConstants.EventKind.SINGLE_STEP);
        ...
        // 8 - Check we reach the catch handler location
