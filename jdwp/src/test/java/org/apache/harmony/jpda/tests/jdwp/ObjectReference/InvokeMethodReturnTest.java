...
public class InvokeMethodReturnTest extends JDWPInvokeMethodTestCase {
    ...
    public void testInvokeInstanceMethodBoolean() {
        runTestInvokeMethod("testInstanceBoolean", new Value(InvokeMethodReturnDebuggee.EXPECTED_BOOLEAN_RESULT));
    }
    ...
    public void testInvokeInstanceMethodByte() {
        runTestInvokeMethod("testInstanceByte", new Value(InvokeMethodReturnDebuggee.EXPECTED_BYTE_RESULT));
    }
    ...
    public void testInvokeInstanceMethodChar() {
        runTestInvokeMethod("testInstanceChar", new Value(InvokeMethodReturnDebuggee.EXPECTED_CHAR_RESULT));
    }
    ...
    public void testInvokeInstanceMethodShort() {
        runTestInvokeMethod("testInstanceShort", new Value(InvokeMethodReturnDebuggee.EXPECTED_SHORT_RESULT));
    }
    ...
    public void testInvokeInstanceMethodInt() {
        runTestInvokeMethod("testInstanceInt", new Value(InvokeMethodReturnDebuggee.EXPECTED_INT_RESULT));
    }
    ...
    public void testInvokeInstanceMethodFloat() {
        runTestInvokeMethod("testInstanceFloat", new Value(InvokeMethodReturnDebuggee.EXPECTED_FLOAT_RESULT));
    }
    ...
    public void testInvokeInstanceMethodLong() {
        runTestInvokeMethod("testInstanceLong", new Value(InvokeMethodReturnDebuggee.EXPECTED_LONG_RESULT));
    }
    ...
    public void testInvokeInstanceMethodDouble() {
        runTestInvokeMethod("testInstanceDouble", new Value(InvokeMethodReturnDebuggee.EXPECTED_DOUBLE_RESULT));
    }
    ...
    private void runTestInvokeMethod(String methodName, Value expectedValue) {
        ...
        Value returnValue = invokeInstanceMethodWithoutException(receiverID, typeID, targetThreadID, targetMethodID);
        assertEquals("Invalid return value", expectedValue, returnValue);

        // Make InvokeMethod with Exception
        TaggedObject exception = invokeInstanceMethodWithException(receiverID, typeID, targetThreadID, targetMethodID);
    ...
    private Value invokeInstanceMethodWithoutException(long receiveID, long typeID, long targetThreadID,
            long targetMethodID) {
        ReplyPacket reply = invokeInstanceMethod(receiveID, typeID, targetThreadID, targetMethodID, false);
    ...
    private TaggedObject invokeInstanceMethodWithException(long receiveID, long typeID, long targetThreadID,
            long targetMethodID) {
        ReplyPacket reply = invokeInstanceMethod(receiveID, typeID, targetThreadID, targetMethodID, true);
    ...
    private ReplyPacket invokeInstanceMethod(long receiveID, long typeID, long targetThreadID,
        ...
        ReplyPacket reply = invokeMethod(receiveID, typeID, targetThreadID, targetMethodID, args, options);
