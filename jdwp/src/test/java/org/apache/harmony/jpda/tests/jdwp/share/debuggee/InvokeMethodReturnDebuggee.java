...
public class InvokeMethodReturnDebuggee extends SyncDebuggee {
    ...
    public void run() {
        ...
        // TODO check which signal must be used.
        // synchronizer.receiveMessage(JPDADebuggeeSynchronizer.SGNL_CONTINUE);
        synchronizer.receiveMessageWithoutException("InvokeMethodReturnDebuggee(#1)");
        execMethod();
        // synchronizer.receiveMessage(JPDADebuggeeSynchronizer.SGNL_CONTINUE);
        synchronizer.receiveMessageWithoutException("InvokeMethodReturnDebuggee(#2)");
    }
