 ...
 */
public class InvokeMethodWithThreadSuspensionTest extends JDWPInvokeMethodWithThreadSuspensionTestCase {
    public void testInvokeWithMultipleEvents001() {
        runInvokeMethodTest(InvokeMethodWithThreadSuspensionDebuggee.INSTANCE_METHOD_NAME);
    }
