...
public class FieldWithLocationTest extends EventLocationEventTestCase {
    ...
    private void runFieldLocationTest(boolean modification) {
        ...
        final boolean supportCapability;
        if (modification) {
            // Field modification.
            eventKind = JDWPConstants.EventKind.FIELD_MODIFICATION;
            capabilityname = "canWatchFieldModification";
            supportCapability = debuggeeWrapper.vmMirror.canWatchFieldModification();
        } else {
            // Field access.
            eventKind = JDWPConstants.EventKind.FIELD_ACCESS;
            capabilityname = "canWatchFieldAccess";
            supportCapability = debuggeeWrapper.vmMirror.canWatchFieldAccess();
        }
