...
import org.apache.harmony.jpda.tests.jdwp.share.JDWPInvokeMethodWithThreadSuspensionTestCase;
import org.apache.harmony.jpda.tests.share.JPDADebuggeeSynchronizer;
import org.apache.harmony.jpda.tests.share.SyncDebuggee;

/**
 * Debuggee for subclasses of {@link JDWPInvokeMethodWithThreadSuspensionTestCase}.
 */
public class InvokeMethodWithThreadSuspensionDebuggee extends SyncDebuggee {
    ...
    public InvokeMethodWithThreadSuspensionDebuggee() {
        causeEventThreadSuspension();
    }
    ...
    public static void main(String[] args) {
        runDebuggee(InvokeMethodWithThreadSuspensionDebuggee.class);
    }
}
