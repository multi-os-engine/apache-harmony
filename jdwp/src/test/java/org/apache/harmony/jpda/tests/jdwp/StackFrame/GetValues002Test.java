...
public class GetValues002Test extends JDWPStackFrameAccessTest {
    ...
    // TODO: restore the test when we can handle different values to a variable that we do not
    // change from the debugger (here "local" is updated by the debuggee)
    //    /**
    ...
    //        methodInfo.addVariable("param", oldValue);
    //        methodInfo.addVariable("local", oldValue);
    //        runStackFrameTest(tester, suspensionMethodInfo);
    //    }
