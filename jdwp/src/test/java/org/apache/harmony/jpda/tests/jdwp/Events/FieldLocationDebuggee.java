...
/**
 * Debuggee for FieldAccessLocationTest and FieldModificationLocationTest unit
 * tests.
 */
public class FieldLocationDebuggee extends SyncDebuggee {

    public static void main(String[] args) {
        runDebuggee(FieldLocationDebuggee.class);
    }
