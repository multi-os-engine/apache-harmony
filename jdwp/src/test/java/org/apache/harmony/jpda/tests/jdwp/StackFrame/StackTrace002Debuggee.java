...
public class StackTrace002Debuggee extends SyncDebuggee {
    ...
    static final String INT_CONSTANT_METHOD_WITH_EXCEPTION_AND_NATIVE_TRANSITION_SIGNAL = "runBreakpointIntConstantWithExceptionAndNativeTransition";
    ...
    public void run() {
        ...
        switch (signal) {
            ...
            case INT_CONSTANT_METHOD_WITH_EXCEPTION_IN_CALLER_SIGNAL:
                ...
                break;
            case INT_CONSTANT_METHOD_WITH_EXCEPTION_AND_NATIVE_TRANSITION_SIGNAL:
