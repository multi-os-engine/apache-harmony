...
/**
 * Debuggee for ExceptionLocationTest unit test.
...
public class ExceptionWithLocationDebuggee extends SyncDebuggee {
    ...
    public void run() {
        logWriter.println("-- ExceptionLocationDebuggee: STARTED");
        // load and prepare DebuggeeException class
        DebuggeeException ex = new DebuggeeException("dummy exception");

        synchronizer.sendMessage(JPDADebuggeeSynchronizer.SGNL_READY);

        logWriter.println("-- ExceptionLocationDebuggee: Wait for SGNL_CONTINUE...");
        synchronizer.receiveMessage(JPDADebuggeeSynchronizer.SGNL_CONTINUE);
        logWriter.println("-- ExceptionLocationDebuggee: SGNL_CONTINUE has been received!");

        unexpectedThrowException();
        expectedThrowException();

        logWriter.println("-- ExceptionLocationDebuggee: FINISHing...");
    }
}
