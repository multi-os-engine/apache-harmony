...
public class InvokeMethodReturnTest extends JDWPInvokeMethodTestCase {
    ...
    public void testInvokeStaticMethodBoolean() {
        runTestInvokeMethod("testStaticBoolean", new Value(InvokeMethodReturnDebuggee.EXPECTED_BOOLEAN_RESULT));
    }
    ...
    public void testInvokeStaticMethodByte() {
        runTestInvokeMethod("testStaticByte", new Value(InvokeMethodReturnDebuggee.EXPECTED_BYTE_RESULT));
    }
    ...
    public void testInvokeStaticMethodChar() {
        runTestInvokeMethod("testStaticChar", new Value(InvokeMethodReturnDebuggee.EXPECTED_CHAR_RESULT));
    }
    ...
    public void testInvokeStaticMethodShort() {
        runTestInvokeMethod("testStaticShort", new Value(InvokeMethodReturnDebuggee.EXPECTED_SHORT_RESULT));
    }
    ...
    public void testInvokeStaticMethodInt() {
        runTestInvokeMethod("testStaticInt", new Value(InvokeMethodReturnDebuggee.EXPECTED_INT_RESULT));
    }
    ...
    public void testInvokeStaticMethodFloat() {
        runTestInvokeMethod("testStaticFloat", new Value(InvokeMethodReturnDebuggee.EXPECTED_FLOAT_RESULT));
    }
    ...
    public void testInvokeStaticMethodLong() {
        runTestInvokeMethod("testStaticLong", new Value(InvokeMethodReturnDebuggee.EXPECTED_LONG_RESULT));
    }
    ...
    public void testInvokeStaticMethodDouble() {
        runTestInvokeMethod("testStaticDouble", new Value(InvokeMethodReturnDebuggee.EXPECTED_DOUBLE_RESULT));
    }
    ...
    private void runTestInvokeMethod(String methodName, Value expectedValue) {
        ...
        Value returnValue = invokeStaticMethodWithoutException(typeID, targetThreadID, targetMethodID);
        assertEquals("Invalid return value", expectedValue, returnValue);

        // Make InvokeMethod with Exception
        TaggedObject exception = invokeStaticMethodWithException(typeID, targetThreadID, targetMethodID);
