...
/**
 * Debuggee for MethodExitWithReturnValue002Test.
 */
public class MethodExitWithReturnValue002Debuggee extends SyncDebuggee {
    public static final int SUCCESS_RESULT = 1;
    public static final int FAILURE_RESULT = 0;

    public static void main(String[] args) {
        runDebuggee(MethodExitWithReturnValue002Debuggee.class);
    }

    public void run() {
        logWriter.println("--> MethodExitWithReturnValue002Debuggee started");
        ...
        logWriter.println("--> MethodExitWithReturnValue002Debuggee finished");
    }
    ...
    private static void breakpointMethod() {
        System.out.println("TestBadException2.breakpoint()");
    }
