...
jdwp_test_runtime_host := $(HOST_OUT_EXECUTABLES)/art
...
run-jdwp-tests-host: $(jdwp_test_runtime_host) $(HOST_OUT_JAVA_LIBRARIES)/apache-harmony-jdwp-tests-hostdex.jar $(HOST_OUT_JAVA_LIBRARIES)/junit-hostdex.jar
