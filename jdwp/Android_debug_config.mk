...
jdwp_test_common_runtime_options :=
...
jdwp_test_debuggee_runtime_options := -Xcompiler-option --debuggable # mandatory
#jdwp_test_debuggee_runtime_options += -verbose:jdwp
#jdwp_test_debuggee_runtime_options += -Xint # interpret-only mode
#jdwp_test_debuggee_runtime_options += -Xnoimage-dex2oat # imageless mode
#jdwp_test_debuggee_runtime_options += -Xcompiler-option --compiler-backend=Optimizing # optimizing compiler
...
.PHONY: $(2)
$(2): jdwp_test_runtime_target := $(jdwp_test_runtime_bin_target)$(1) $(jdwp_test_target_runtime_options)
