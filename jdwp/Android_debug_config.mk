...
# The latest declared host/target ABI-specific rule (ex: run-jdwp-tests-host-all32)
# This is used to build a chain of dependency so we can run JDWP tests on all supported
# ABIs using a high-level host or target rule, respectively run-jdwp-tests-host and
# run-jdwp-tests-target
jdwp_tests_previous_host_rule :=
jdwp_tests_previous_target_rule :=
