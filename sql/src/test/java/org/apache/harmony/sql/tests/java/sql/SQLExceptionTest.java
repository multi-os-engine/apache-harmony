...
public class SQLExceptionTest extends TestCase {
    ...
    public void testConstructor_LString_Throwable() {
        Exception e = new Exception("error");
        SQLException exception = new SQLException("reason", e);
        assertEquals(e, exception.getCause());
        assertEquals("error", exception.getCause().getMessage());
    ...
    public void testConstructor_LString_String_Throwable() {
        Exception e = new Exception("error");
        SQLException exception = new SQLException("reason", "state", e);
        assertEquals(e, exception.getCause());
        assertEquals("error", exception.getCause().getMessage());
        assertEquals("reason", exception.getMessage());
    ...
    public void testConstructor_LString_String_I_Throwable() {
        Exception e = new Exception("error");
        SQLException exception = new SQLException("reason", "state", 18, e);
        assertEquals(e, exception.getCause());
        assertEquals("error", exception.getCause().getMessage());
        assertEquals("reason", exception.getMessage());
        assertEquals("state", exception.getSQLState());
        assertEquals(18, exception.getErrorCode());
    }
    ...
    public void test_iterator() throws Exception {
        ...
        se3.setNextException(null);
        se3.setNextException(se4);
        Iterator iterator = se1.iterator();
        try {
            iterator.remove();
        ...
        assertEquals(se1, iterator.next());
        assertEquals(se2, iterator.next());
        assertEquals(se3, iterator.next());
        assertEquals(se4, iterator.next());
